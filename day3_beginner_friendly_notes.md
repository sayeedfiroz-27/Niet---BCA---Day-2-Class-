<h1>Day 3 - Beginner Friendly Notes</h1>

<p class="viewer-heading">Beginner-friendly classroom notes. Read from top to bottom: first concept, then practical code, then output, then detailed explanation.</p>

<section class="card"><h2>How to Study This Page</h2><p>Is document ko step-by-step padhna hai. Pehle topic ka meaning samjho, phir real-world use dekho, phir code run karo, phir output compare karo, aur last me detailed code explanation table se har line ka role samjho. Ye flow isliye rakha gaya hai taaki beginner learner ko syntax ke saath project thinking bhi samajh aaye.</p></section>
